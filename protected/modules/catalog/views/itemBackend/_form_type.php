...
echo $form->dropDownListControlGroup($model, 'category_id', $data, array('data-url' => Yii::app()->createUrl('/catalog/itemBackend/itemProps'), 'data-item_id' => $model->item_id ? $model->item_id : 0));
?>
...
<input type="hidden" id="skus_info" data-id="<?php echo ($model->item_id) ? $model->item_id : 0; ?>"
       data-url="<?php echo Yii::app()->createUrl('/catalog/itemBackend/ajaxGetSkus'); ?>" value=""/>
