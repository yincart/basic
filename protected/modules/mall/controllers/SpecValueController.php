...
class SpecValueController extends MallBaseController {
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SpecValue']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->spec_value_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('SpecValue');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='spec-value-form')
		{
