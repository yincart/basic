...
//        'method'=>'GET'
    ...
    <div class="input-group space">
        ...
        <?php echo $form->textField($model, 'status', array('class' => 'form-control form-control1')); ?>
    </div>

    <div class="input-group space">
        <?php echo $form->labelEx($model, 'pay_status', array('class' => 'input-group-addon')); ?>
        <?php echo $form->textField($model, 'pay_status', array('class' => 'form-control form-control1')); ?>
    </div>

    <div class="input-group space">
        <?php echo $form->labelEx($model, 'ship_status', array('class' => 'input-group-addon')); ?>
        <?php echo $form->textField($model, 'ship_status', array('class' => 'form-control form-control1')); ?>
    </div>

    <div class="input-group space">
        <?php echo $form->labelEx($model, 'refund_status', array('class' => 'input-group-addon')); ?>
        <?php echo $form->textField($model, 'refund_status', array('class' => 'form-control form-control1')); ?>
    </div>
    ...
    <div class="input-group space">
        ...
        <?php echo $form->textField($model, 'pay_method', array('size' => 45, 'maxlength' => 45, 'class' => 'form-control form-control1')); ?>
    </div>

    <div class="input-group space">
        <?php echo $form->labelEx($model, 'ship_method', array('class' => 'input-group-addon')); ?>
        <?php echo $form->textField($model, 'ship_method', array('size' => 45, 'maxlength' => 45, 'class' => 'form-control form-control1')); ?>
    </div>
