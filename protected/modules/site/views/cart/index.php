...
<div class="box">
    ...
    <div class="box-content cart">
        ...
        <table width="100%" border="1" cellspacing="1" cellpadding="0" style="text-align:center;vertical-align:middle">
            ...
            <tr>
                <td colspan="6" style="vertical-align:middle"><span style="float:left;padding:5px 10px;"><?php echo CHtml::link('清空购物车', array('/cart/destory'), array('class'=>'btn1'))?></span>
        <span style="float:right;padding:5px 10px;"><?php echo CHtml::link('继续购物', array('/item-list-all'), array('class'=>'btn1'))?></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="float:right;padding:5px 10px;"><?php echo CHtml::link('更新购物车', '#', array('id'=>'updateCart', 'class'=>'btn1'))?></span></td>
            </tr>
            <tr>
