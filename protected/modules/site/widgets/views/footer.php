    ...
    <div class="footer_bottom_part">
        <div class="container clearfix t_mxs_align_c">
            ...
            <ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
                ...
                <li class="m_left_5"><img src="<?php echo F::themeUrl() ?>/images/payment_img_3.png" alt=""></li>
                <li class="m_left_5"><img src="<?php echo F::themeUrl() ?>/images/payment_img_4.png" alt=""></li>
                <li class="m_left_5"><img src="<?php echo F::themeUrl() ?>/images/payment_img_5.png" alt=""></li>
            </ul>
        </div>
    </div>
</footer>