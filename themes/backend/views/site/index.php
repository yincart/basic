                ...
                <div class='sortable-container'>
                    ...
                    <ul class='unstyled sortable' data-sortable-axis='y' data-sortable-connect='.sortable'>
                        <li class='important item'>
                            <label class='check pull-left todo'>
                                <input type='checkbox'>
                                <span>Rerum incidunt voluptates</span>
                            </label>
                        ...
                        <li class='done item'>
                            <label class='check pull-left todo'>
                                ...
                                <span>Saepe repudiandae nesciunt</span>
                            </label>
                            <div class='actions pull-right'>
                                <a class='btn btn-link edit has-tooltip' data-placement='top' href='#' title='Edit todo'>
                                    <i class='icon-pencil'></i>
                        ...
                        <li class='item'>
                            <label class='check pull-left todo'>
                                ...
                                <span>Possimus ipsam labore facere</span>
                            </label>
                            <div class='actions pull-right'>
                                <a class='btn btn-link edit has-tooltip' data-placement='top' href='#' title='Edit todo'>
                                    <i class='icon-pencil'></i>
                    ...
                    <ul class='unstyled sortable' data-sortable-axis='y' data-sortable-connect='.sortable'>
                        <li class='item'>
                            <label class='check pull-left todo'>
                                <input type='checkbox'>
                                <span>Vitae omnis iusto asperiores id</span>
                            </label>
                            <div class='actions pull-right'>
                                <a class='btn btn-link edit has-tooltip' data-placement='top' href='#' title='Edit todo'>
                                    <i class='icon-pencil'></i>
                        ...
                        <li class='important item'>
                            <label class='check pull-left todo'>
                                <input type='checkbox'>
                                <span>Et soluta numquam adipisci quidem</span>
                            </label>
                            <div class='actions pull-right'>
                                <a class='btn btn-link edit has-tooltip' data-placement='top' href='#' title='Edit todo'>
                                    <i class='icon-pencil'></i>
                        ...
                        <li class='item'>
                            <label class='check pull-left todo'>
                                <input type='checkbox'>
                                <span>Iure et et quidem perspiciatis</span>
                            </label>
                            <div class='actions pull-right'>
                                <a class='btn btn-link edit has-tooltip' data-placement='top' href='#' title='Edit todo'>
                                    <i class='icon-pencil'></i>
                        ...
                        <li class='item'>
                            <label class='check pull-left todo'>
                                <input type='checkbox'>
                                <span>Fugiat tempora dicta porro dolorum</span>
                            </label>
                            <div class='actions pull-right'>
                                <a class='btn btn-link edit has-tooltip' data-placement='top' href='#' title='Edit todo'>
                                    <i class='icon-pencil'></i>
    ...
    <ul class='unstyled users list-hover list-striped'>
        <li>
            ...
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:18:13 +0200'>September 10, 2013 - 22:18</span>
                <i class='icon-time'></i>
            </small>
        </li>
        <li>
            ...
            <div class='action pull-left'>
                <a class="text-contrast" href="#">Bart</a>
                uploaded photo
            </div>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:19:13 +0200'>September 10, 2013 - 22:19</span>
                <i class='icon-time'></i>
            </small>
        </li>
        <li>
            ...
            <div class='action pull-left'>
                <a class="text-contrast" href="#">Ida</a>
                uploaded photo
            </div>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:20:13 +0200'>September 10, 2013 - 22:20</span>
                <i class='icon-time'></i>
            </small>
        </li>
        <li>
            ...
            <div class='action pull-left'>
                <a class="text-contrast" href="#">Kenneth</a>
                signed up
            </div>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:21:13 +0200'>September 10, 2013 - 22:21</span>
                <i class='icon-time'></i>
            </small>
        </li>
        <li>
            ...
            <div class='action pull-left'>
                <a class="text-contrast" href="#">Daren</a>
                commented
            </div>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:22:13 +0200'>September 10, 2013 - 22:22</span>
                <i class='icon-time'></i>
            </small>
        </li>
        <li>
            ...
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:23:13 +0200'>September 10, 2013 - 22:23</span>
                <i class='icon-time'></i>
            </small>
        </li>
    </ul>
...
<div class='tab-pane fade' id='comments'>
    <ul class='unstyled comments list-hover list-striped'>
        <li>
            ...
            <div class='body'>
                <div class='name'><a class="text-contrast" href="#">Chris</a></div>
                <div class='actions'>
                ...
                <div class='text'>Dolore et autem molestias porro aut est repellat beatae est harum animi. Sunt nostrum nam itaque suscipit sint rem autem dolor amet quis</div>
            </div>
            <div class='text-right'>
                <small class='date muted'>
                    <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 23:17:13 +0200'>September 10, 2013 - 23:17</span>
                    <i class='icon-time'></i>
                </small>
            </div>
        </li>
        <li>
            ...
            <div class='body'>
                <div class='name'><a class="text-contrast" href="#">inn</a></div>
                <div class='actions'>
                    <a class="btn btn-link ok has-tooltip" title="Approve" href="#"><i class='icon-thumbs-up'></i>
                    </a>
                ...
                <div class='text'>Deserunt eum cumque alias architecto et. Eum pariatur odit dicta odit et similique non id laborum</div>
            </div>
            <div class='text-right'>
                <small class='date muted'>
                    <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-11 00:17:13 +0200'>September 11, 2013 - 00:17</span>
                    <i class='icon-time'></i>
                </small>
            </div>
        </li>
        <li>
            ...
            <div class='body'>
                <div class='name'><a class="text-contrast" href="#">Alma</a></div>
                <div class='actions'>
                    <a class="btn btn-link ok has-tooltip" title="Approve" href="#"><i class='icon-thumbs-up'></i>
                    </a>
                ...
                <div class='text'>Aperiam quaerat beatae molestiae sint ipsa est repellat. Occaecati tempora qui animi</div>
            </div>
            <div class='text-right'>
                <small class='date muted'>
                    <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-11 01:17:13 +0200'>September 11, 2013 - 01:17</span>
                    <i class='icon-time'></i>
                </small>
            </div>
        </li>
        <li>
            ...
            <div class='body'>
                <div class='name'><a class="text-contrast" href="#">Judith</a></div>
                <div class='actions'>
                    <a class="btn btn-link ok has-tooltip" title="Approve" href="#"><i class='icon-thumbs-up'></i>
                    </a>
                ...
                <div class='text'>Excepturi necessitatibus id ducimus earum qui rerum quas autem voluptatibus architecto dolores deleniti quam. Consequatur cumque eum omnis dicta sunt et distinctio ipsam aut consectetur</div>
            </div>
            <div class='text-right'>
                <small class='date muted'>
                    <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-11 02:17:13 +0200'>September 11, 2013 - 02:17</span>
                    <i class='icon-time'></i>
                </small>
            </div>
        </li>
        <li>
            ...
            <div class='body'>
                <div class='name'><a class="text-contrast" href="#">Nolan</a></div>
                <div class='actions'>
                    <a class="btn btn-link ok has-tooltip" title="Approve" href="#"><i class='icon-thumbs-up'></i>
                    </a>
                ...
                <div class='text'>Eligendi perspiciatis voluptatem voluptatem labore. Quo explicabo reiciendis et nam</div>
            </div>
            <div class='text-right'>
                <small class='date muted'>
                    <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-11 03:17:13 +0200'>September 11, 2013 - 03:17</span>
                    <i class='icon-time'></i>
                </small>
            </div>
        </li>
        <li>
            ...
            <div class='body'>
                <div class='name'><a class="text-contrast" href="#">Tonia</a></div>
                <div class='actions'>
                    <a class="btn btn-link ok has-tooltip" title="Approve" href="#"><i class='icon-thumbs-up'></i>
                    </a>
                ...
                <div class='text'>Optio excepturi dolorum non quos. Nesciunt enim inventore qui omnis repellat excepturi adipisci expedita</div>
            </div>
            <div class='text-right'>
                <small class='date muted'>
                    <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-11 04:17:13 +0200'>September 11, 2013 - 04:17</span>
                    <i class='icon-time'></i>
                </small>
            </div>
        </li>
...
<li class='message'>
    ...
    <div class='name-and-time'>
        <div class='name pull-left'>
            <small>
                <a class="text-contrast" href="#">Cathleen</a>
            </small>
        </div>
        <div class='time pull-right'>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:26:13 +0200'>September 10, 2013 - 22:26</span>
                <i class='icon-time'></i>
            </small>
        </div>
    </div>
    <div class='body'>
        Explicabo quia velit repellat labore magnam quidem accusamus perspiciatis et ea non itaque voluptatem quos
    </div>
</li>
<li class='message'>
    <div class='avatar'>
    ...
    <div class='name-and-time'>
        <div class='name pull-left'>
            <small>
                <a class="text-contrast" href="#">Wayne</a>
            </small>
        </div>
        <div class='time pull-right'>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:25:13 +0200'>September 10, 2013 - 22:25</span>
                <i class='icon-time'></i>
            </small>
        </div>
    </div>
    <div class='body'>
        Rerum error officia consequatur sed itaque est ut quia fugit expedita laudantium soluta consequuntur
    </div>
</li>
<li class='message'>
    <div class='avatar'>
    ...
    <div class='name-and-time'>
        ...
        <div class='time pull-right'>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:24:13 +0200'>September 10, 2013 - 22:24</span>
                <i class='icon-time'></i>
            </small>
        </div>
    </div>
    <div class='body'>
        Doloremque deleniti consequatur dolore ut est et unde possimus voluptas quo quia distinctio fugiat quas
    </div>
</li>
<li class='message'>
    <div class='avatar'>
    ...
    <div class='body'>
        Error minima nemo magni repellendus qui accusantium error laboriosam aliquam aspernatur quaerat nulla quia
    </div>
</li>
<li class='message'>
    <div class='avatar'>
    ...
    <div class='body'>
        Enim vel praesentium magni laboriosam nostrum doloremque velit esse et ea et ut eos doloribus
    </div>
</li>
<li class='message'>
    <div class='avatar'>
    ...
    <div class='body'>
        Voluptate repellendus unde voluptatem sit rerum eos aliquid et
    </div>
</li>
<li class='message'>
    <div class='avatar'>
    ...
    <div class='body'>
        Maiores sed corrupti dolor asperiores libero et et voluptas corrupti et et quisquam
    </div>
</li>
<li class='message'>
    <div class='avatar'>
...
<li class='message'>
    ...
    <div class='name-and-time'>
        ...
        <div class='time pull-right'>
            <small class='date pull-right muted'>
                <span class='timeago fade has-tooltip' data-placement='top' title='2013-09-10 22:17:13 +0200'>September 10, 2013 - 22:17</span>
                <i class='icon-time'></i>
            </small>
        </div>
    </div>
    <div class='body'>
        Ducimus sapiente ipsum doloribus
    </div>
</li>
</ul>
</div>
