...
//    'type'=>'horizontal',
            ...
            <div class='row-fluid'>
                <div class='span12 icon-over-input'>
                    <input value="" placeholder="Username" class="span12" name="LoginForm[username]" type="text" />
                    <i class='icon-user muted'></i>
                </div>
            </div>
            <div class='row-fluid'>
                <div class='span12 icon-over-input'>
                    <input value="" placeholder="Password" class="span12" name="LoginForm[password]" type="password" />
                    <i class='icon-lock muted'></i>
                </div>
            </div>
            <label class='checkbox' for='remember_me'>
                <input id='LoginForm_rememberMe' name='LoginForm[rememberMe]' type='checkbox' value='1'>
                Remember me
            </label>
